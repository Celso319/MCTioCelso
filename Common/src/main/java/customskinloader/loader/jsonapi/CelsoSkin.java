...
/**
 * CelsoSkin API loader
 * Uses only https://skin.celso.app.br/
 */
public class CelsoSkin implements JsonAPILoader.IJsonAPI {

    /** 
     * Single default profile that points to your site.
     */
    public static class CelsoSkinProfile extends JsonAPILoader.DefaultProfile {
        public CelsoSkinProfile(JsonAPILoader loader) {
            super(loader);
        }
        ...
        public String getRoot() {
            return "https://skin.celso.app.br/";
        }
    }
    ...
    public List<ICustomSkinLoaderPlugin.IDefaultProfile> getDefaultProfiles(JsonAPILoader loader) {
        // Only your own site
        return Lists.newArrayList(new CelsoSkinProfile(loader));
    }
    ...
    public UserProfile toUserProfile(String root, String json, boolean local) {
        CelsoSkinProfileJson profile = CustomSkinLoader.GSON.fromJson(json, CelsoSkinProfileJson.class);
    ...
    private static class CelsoSkinProfileJson {
